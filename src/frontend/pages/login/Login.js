        ...
        <div className="form-container">
            {signingUp && !isForgotPassword && (
                <form
                    ...
                    <Select placeholder="Select Team" options={teams} onChange={(option) => { setUserTeam(option.value) }} styles={colourStyles} className="selector" />
                    <Select placeholder="Select Role" options={roles} onChange={(option) => { setUserRole(option.value) }} styles={colourStyles} className="selector" />
